...
export function GenderCard({ movie, onClick, style }) {
  ...
  return (
    <div
      className="gender-card improved-gender-card"
      tabIndex={0}
      onClick={onClick}
      ...
      <div className="gender-card__info">
        ...
        <div className="gender-card__meta">
          <span className="gender-card__rating">
            <i className="gender-card__star">★</i>{" "}
            {movie.vote_average?.toFixed(1) ?? "N/A"}
          </span>
          <span className="gender-card__date">
            {movie.release_date}
          </span>
        </div>
      </div>
